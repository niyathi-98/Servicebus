...
namespace ServiceBusAzure
{
    class Program
    {
        static string connectionString = "Endpoint=sb://newbus1.servicebus.windows.net/;SharedAccessKeyName=RootManageSharedAccessKey;SharedAccessKey=9FA76AyHpXHa7dnXh6NQ63gy53wXHV4+g08BII/iAbM=";
        static string queueName = "samplemessages";
